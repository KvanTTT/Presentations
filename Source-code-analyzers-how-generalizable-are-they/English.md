...
они являются иерархическими иерархическими. А следующие структуры вообще графовые,
...
сигнализировать о неправильном форматировании, однако на уровне графов потоков
данных это выяснить не получится.

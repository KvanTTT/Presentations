...
проголосуем вновь и посмотрим, поменялось ли ваше мнение. Надеюсь кто-то из вас
почувствует себя немного профессионалом и воздержавшихся станет меньше.

Для того, чтобы разобраться в этом вопросе, давайте разобьем модели исходного кода
на следующие типы: регулярные выражения, токены, деревья разбора
...
токенов. Их уже необходимо унифицировать. Но это не так сложно сделать, как
...
помощью них можно находить в контексте ИБ, а также пофантазирую о том, как могли
бы выглядеть предметно-ориентированные языки под них, т.е. DSL. На DSL я
акцентирую внимание DSL, потому что они хорошо отображают сущности рассматриваемых моделей.
</aside>
...
Рассмотрим регулярку с открывающим и закрывающим тегом table: `<table>(.*?)</table>`.
